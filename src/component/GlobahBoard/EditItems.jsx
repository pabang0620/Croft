...
const EditItems = () => {
  ...
  return (
    <div className="w-[386px] h-[50vh] flex flex-col bg-white shadow-lg rounded-[10px] text-info py-[10px] px-[15px]">
              ...
              {itemArray[i].map((item, idx) => (
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      handleCheckboxChange(stateArray[i], setStateArray[i], idx)
                    }
                  />
                  <div>
