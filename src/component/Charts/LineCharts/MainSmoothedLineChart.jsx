...
const MainSmoothedLineChart = ({
  ...
  const { data, isLoading, error } = useChartData(
    `${process.env.REACT_APP_BASE_API_KEY}/v1/farms/measurement/day?data_type=${dataType}`,
    `chartData-${dataType}`
  );
  ...
  return (
    <div className="relative">
      ...
      {atDetail && (
        <div
          className="absolute bottom-[9px] right-[29px] text-[#124946] text-xs font-normal leading-normal cursor-pointer"
